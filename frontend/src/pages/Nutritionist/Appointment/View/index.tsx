...
export const NutritionistAppointmentViewPage: SFC = ({ ClassName }) => {
    ...
    <>
      <S.Container className={cn("", ClassName)}>
        <S.PageTopBar className="h-[40px]">
          <PageBreadCrumbs Links={links} Active="Appointments" />
          <S.Actions>
            <CustomButton
              leftIcon={<Icon.Add className="md:text-white text-primary" />}
              onClick={() =>
                navigate(RouteChannel.NUTRITIONIST_APPOINTMENT_NEW)
              }
              text="New"
...
export default memo(NutritionistAppointmentViewPage);

...
export const NutritionistARTICLEDetailsPage: SFC = ({ ClassName }) => {
    ...
    <>
      <S.Container className={cn("", ClassName)}>
        <S.PageTopBar className="h-[40px]">
          <PageBreadCrumbs Links={links} Active="Health Article Details" />
          <S.Actions>
            <CustomButton
...
export default memo(NutritionistARTICLEDetailsPage);

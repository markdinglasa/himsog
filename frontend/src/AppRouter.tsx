        ...
        <Route element={<PersistContext />}>
          ...
          >
            <Route element={<AdminLayout />}>
              ...
              />
              <Route
                path={RouteChannel.ADMIN_ARTICLE}
                element={<Page.Admin.Setups.Article.View />}
              />
              <Route
                path={RouteChannel.ADMIN_ARTICLE_DETAILS}
                element={<Page.Admin.Setups.Article.Details />}
              />
              <Route
          ...
          >
            ...
            <Route element={<ClientLayout />}>
              ...
              />
              <Route
                path={RouteChannel.CLIENT_MY_MEAL_PLAN}
                element={<Page.Client.MealPlan.My />}
              />
              <Route
              ...
              />
              <Route
                path={RouteChannel.CLIENT_PRESET_MEAL_PLAN_PAYMENT}
                element={<Page.Client.MealPlan.Payment />}
              />
              <Route
          ...
          >
            ...
            <Route element={<NutritionistLayout />}>
              ...
              />
              <Route
                path={RouteChannel.NUTRITIONIST_MEAL_NEW_DETAILS}
                element={<Page.Nutritionist.Meal.NewDetails />}
              />
              <Route
              ...
              <Route
                ...
                element={<Page.Nutritionist.MealPlan.View />}
              />
              <Route
